...
public partial class AdminProductDetails : System.Web.UI.Page
{
  ...
  private void PopulateControls()
  {
    ...
    CatalogAccess.ProductDetails productDetails = CatalogAccess.GetProductDetails(currentProductId);
    CatalogAccess.CategoryDetails categoryDetails = CatalogAccess.GetCategoryDetails(currentCategoryId);
  ...
  protected void upload1Button_Click(object sender, EventArgs e)
  {
    ...
    if (image1FileUpload.HasFile)
    {
      try
      {
        ...
        CatalogAccess.ProductDetails pd = CatalogAccess.GetProductDetails(currentProductId);
